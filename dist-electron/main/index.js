...
var package_default = {
  ...
  scripts: {
    ...
    "build:electron": "esbuild electron/main/index.ts --bundle --platform=node --format=cjs --packages=external --outfile=dist-electron/main/index.js && esbuild electron/preload/index.ts --bundle --platform=node --format=cjs --packages=external --outfile=dist-electron/preload/index.js",
...
function createWindow() {
  ...
  const preloadPath = import_path.default.join(__dirname, "../preload/index.js");
